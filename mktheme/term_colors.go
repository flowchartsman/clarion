...
// The following has been cribbed from
// https://github.com/gookit/color/blob/master/convert.go
...
func toTerminal(c colorful.Color) string {
	r, g, b := c.RGB255()
	res := make([]uint8, 3)
