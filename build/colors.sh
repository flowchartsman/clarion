...
echo
echo
echo -e "\033[0mDefault Foreground"
echo -e "\033[1;37mWHITE\t\033[0;37mBRIGHT_WHITE"
...
echo -e "\033[0;35mMAGENTA\t\033[1;35mBRIGHT_MAGENTA"
echo -e "\033[0;33mYELLOW\t\033[1;33mBRIGHT_YELLOW\033[0m"